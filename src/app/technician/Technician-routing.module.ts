...
import { MeetingscheduleComponent } from './meetingschedule/meetingschedule/meetingschedule.component';
import { MeetingListsComponent } from './meetingLists/meeting-lists/meeting-lists.component';
const routes: Routes = [
  {
    path: 'technician',
